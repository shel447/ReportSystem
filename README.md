...
- `report_runtime` 的确认大纲、执行基线、文档生成、章节生成 helper 也已迁入上下文本地基础设施模块；根级 `outline_review_service.py / template_v2_renderer.py / template_instance_service.py / document_service.py / report_generation_service.py` 已清理
