...
public record PptTableConfiguration(
    ...
    public PptTableConfiguration {
        ...
        preferredRowHeightPx = positive(preferredRowHeightPx, 15.0);
        minRowHeightPx = positive(minRowHeightPx, 10.0);
        maxRowHeightPx = Math.max(minRowHeightPx, positive(maxRowHeightPx, 18.0));
    ...
    public static PptTableConfiguration defaults() {
        return new PptTableConfiguration(true, 24, 15.0, 10.0, 18.0, 7.5, 6.5, 1.5);
    }
