...
def _to_template_instance(row: TemplateInstanceRow) -> TemplateInstance:
    ...
    return TemplateInstance(
        ...
        parameter_values=copy.deepcopy(payload.get("parameterValues") or {}),
        catalogs=copy.deepcopy(payload.get("catalogs") or []),
        delta_views=copy.deepcopy(payload.get("deltaViews") or []),
        template_skeleton_status=copy.deepcopy(payload.get("templateSkeletonStatus") or {}),
