...
class FrontendChatRenderTests(unittest.TestCase):
    ...
    def test_frontend_supports_structured_param_widgets_and_v2_schema(self):
        ...
        panel_path = os.path.join(base, "frontend", "src", "features", "chat-report-flow", "components", "ChatActionPanel.tsx")
        outline_tree_path = os.path.join(base, "frontend", "src", "features", "chat-report-flow", "components", "OutlineTree.tsx")
        ...
        with open(outline_tree_path, "r", encoding="utf-8") as f:
            outline_tree_content = f.read()
        outline_content = panel_content + "\n" + outline_tree_content
        ...
        self.assertIn("保存诉求", panel_content)
        self.assertIn("outline-tree", outline_content)
        self.assertIn("编辑章节", outline_content)
        self.assertIn("outline-tree__toggle", outline_content)
        self.assertIn('"展开" : "折叠"', outline_content)
        self.assertIn("AI", outline_content)
