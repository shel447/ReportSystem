...
> 对应文件：`design/report_system/schemas/report-dsl.schema.json`
> Schema 标题：`Report`
...
- [examples/report-dsl.example.json](examples/report-dsl.example.json)：flow 报告示例。
- [examples/report-dsl-paged.example.json](examples/report-dsl-paged.example.json)：paged/PPT 报告示例。
