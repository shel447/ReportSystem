...
> 本文档是 [总设计文档 (README.md)](README.md) 的子文档，描述系统在当前版本下的接口治理、统一异常、错误码、容量规格与数据保留策略。
...
- `report_system/04-接口契约.md` 记录实际接口与交互流程
- 本文档提供其上层统一治理规则

### 6.2 与实例/文档模块的关系

- `report_system/05-数据模型与持久化.md` 负责说明实例、文档与生成基线的数据模型
- 本文档只补充：
  - 错误语义
  - 对象上限
  - 保留策略
...
- `report_system/03-运行时流程与状态机.md` 负责会话状态机、能力路由、参数追问
- 本文档补充：
  - 聊天错误分类
  - 会话历史的保留原则
  - 对话生成相关接口的限流级别
