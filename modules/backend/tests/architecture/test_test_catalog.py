...
def test_testing_documentation_and_shared_testdata_exist():
    expected = [
        PROJECT_ROOT / "docs" / "implementation" / "testing" / "README.md",
        PROJECT_ROOT / "docs" / "implementation" / "testing" / "backend-cases.md",
        PROJECT_ROOT / "docs" / "implementation" / "testing" / "exporter-cases.md",
        PROJECT_ROOT / "docs" / "implementation" / "testing" / "feature-e2e-cases.md",
...
def test_runtime_and_test_directories_are_documented_as_separate_roots():
    ...
    testing_docs = (PROJECT_ROOT / "docs" / "implementation" / "testing" / "README.md").read_text(encoding="utf-8")
...
def test_backend_test_file_catalog_matches_source_tree():
    catalog = (PROJECT_ROOT / "docs" / "implementation" / "testing" / "backend-cases.md").read_text(encoding="utf-8")
    documented = {
        item
