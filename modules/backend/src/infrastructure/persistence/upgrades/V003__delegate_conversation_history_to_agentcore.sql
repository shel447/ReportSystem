...
ALTER TABLE tbl_export_jobs RENAME TO legacy_export_jobs;
ALTER TABLE tbl_report_documents RENAME TO legacy_report_documents;
ALTER TABLE tbl_report_instances RENAME TO legacy_report_instances;
ALTER TABLE tbl_template_instances RENAME TO legacy_template_instances;
...
INSERT INTO tbl_template_instances SELECT * FROM legacy_template_instances;
...
INSERT INTO tbl_report_instances SELECT * FROM legacy_report_instances;
...
INSERT INTO tbl_export_jobs SELECT * FROM legacy_export_jobs;
...
INSERT INTO tbl_report_documents SELECT * FROM legacy_report_documents;

DROP TABLE legacy_export_jobs;
DROP TABLE legacy_report_documents;
DROP TABLE legacy_report_instances;
DROP TABLE legacy_template_instances;
DROP TABLE tbl_chats;
